...
const FileUpload = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post("/api/upload", formData, title);
        ...
        <div className="animationContainer">
          <div className="app">
            <div className="container display-4  pt-5 pb-3" style={textStyle}>
              <h4 class="d-inline-flex p-2 bd-highlight border border text-dark display-5 font-monospace  rounded p-2">
                TP Detector
              </h4>
              <button
              ...
              {highlightedText && (
                <div className=" mb-5 col-lg-6 parent m-0">
                  <div className="mx-auto ">
                    ...
                    <br />
                    <h3>Reference Citation in Abstract & Conclusion</h3>
                    <div>
                      <ul>
